<%@ Page Title="<%$Resources:PFSalesResource,DashBoard %>" Language="C#" MasterPageFile="~/PFSalesMaster.master"
    AutoEventWireup="true" CodeFile="ConsultantDash.aspx.cs" Inherits="ConsultantDash" %>
                        ...
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblNotification" runat="server" Text="<%$Resources:PFSalesResource,newleadstoyou %>"></asp:Label>
                ...
                <div style="float: left; margin-left: 20px;">
                    <asp:GridView ID="gvActivities" runat="server" CellSpacing="0" Width="100%" CellPadding="0"
                        ...
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:Label ID="lblActivities" runat="server" Text='<%#Bind("Name") %>'></asp:Label>
                                    <asp:LinkButton ID="lnkbtnActivities" runat="server" Text='<%#Bind("LeadNum")  %>'
                                        ToolTip="<%$Resources:PFSalesResource,ViewDetails %>" OnClick="lnkbtnActivities_Click"></asp:LinkButton>
                                    <asp:HiddenField ID="hdfActProspMemNo" runat="server" Value='<%#Bind("MemNo") %>' />
                                    <asp:HiddenField ID="hdfActprospId" runat="server" Value='<%#Bind("Id") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                        <EmptyDataTemplate>
