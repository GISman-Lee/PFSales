<%@ Page Title="<%$ Resources:PFSalesResource,AddContact%>" Language="C#" AutoEventWireup="true"
    CodeFile="AddProspects.aspx.cs" MasterPageFile="~/PFSalesMaster.master" Inherits="AddProspects" %>
                    ...
                    <dl class="dealerRagisterThree">
                        ...
                        <dd>
                            <asp:DropDownList ID="ddlConsultant" CssClass="selectClass" Enabled="false" TabIndex="21"
                                runat="server" OnSelectedIndexChanged="ddlConsultant_SelectedIndexChanged" AutoPostBack="true">
                                <asp:ListItem Value="0" Text="<%$Resources:PFSalesResource,ddlSelect %>"></asp:ListItem>
                            </asp:DropDownList>
                            ...
                            <dd style="width: 30%; float: left; margin-left: 25px;">
                                <div class="button" style="float: left;">
                                    <asp:LinkButton ID="lnkbtnSendEmail" runat="server" OnClick="lnkbtnSendEmail_Click"
                                        ...
                                        ValidationGroup="SendEmail" TabIndex="29"></asp:LinkButton>
                                </div>
                            </dd>
                        </dt>
                    </dl>
                    <asp:Panel ID="pnlFCDetails" runat="server" Style="float: left; width: 100%; height: auto;">
                        <div class="headText">
                        </div>
                        ...
                        <dl class="contactDetailsPop">
                            ...
                            <dd>
                                <asp:TextBox ID="txtEmployer" runat="server" TabIndex="39" CssClass="inputClass"
