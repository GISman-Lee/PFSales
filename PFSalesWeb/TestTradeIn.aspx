<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TestTradeIn.aspx.cs" Inherits="TestTradeIn" %>

<%@ Register Src="UserControls/UC_Header.ascx" TagName="UC_Header" TagPrefix="uc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <%--1 Aug 2013 : For IE 10 Logout button click issue--%>
    ...
    <script src="js/SessionWarningTimer.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        function CheckAllGridCheckbox(gridName, allcheckboxid, internalcheckboxname) {
            objgridName = document.getElementsByName(gridName);

            temp = allcheckboxid.split('_ctl01')
            var TargetBaseControl = document.getElementById(temp[0]);
            var TargetChildControl = internalcheckboxname
            var Inputs = TargetBaseControl.getElementsByTagName("input");
            //Checked/Unchecked all the checkBoxes in side the GridView.
            for (var n = 0; n < Inputs.length; ++n) {
                if (Inputs[n].type == 'checkbox' && Inputs[n].id.indexOf(TargetChildControl, 0) >= 0) {

                    if (document.getElementById(allcheckboxid).checked == true) {
    ...
    <link href="style/jquery.megamenu.css" rel="stylesheet" type="text/css" />
</head>
<body>
    ...
    <div id="wrapper">
        <!--Header-->
        <div class="header">
            <asp:LinkButton ID="lnkbtnDashBoard" runat="server" OnClick="lnkbtnDashBoard_Click"
                ToolTip="<%$Resources:PFSalesResource,GotoDashBoard  %>">
            <div class="logo">
            </div></asp:LinkButton>
            <div class="banner">
            </div>
            <span class="loggedInUserInfo">
        ...
        <div class="maincontaint">
            <div style="margin: 7px 0px 5px 10px;">
                <asp:UpdatePanel ID="UpPanShortCuts" runat="server">
                    <ContentTemplate>
                        <div style="float: left; padding-right: 3px;">
                            <asp:LinkButton ID="lnkbtnGotoDashBoard" runat="server" ToolTip="<%$Resources:PFSalesResource,gotoDash %>"
                                OnClick="lnkbtnGotoDashBoard_Click" Visible="false"><img src="Images/dashboard.png"/></asp:LinkButton>
                            <asp:LinkButton ID="lnkbtnAddProspect" runat="server" ToolTip="<%$Resources:PFSalesResource,Addprospect %>"
                                OnClick="lnkbtnAddProspect_Click" Visible="false"><img src="Images/addContact.png"/></asp:LinkButton>
                            <asp:LinkButton ID="lnkbtnProspectList" runat="server" ToolTip="<%$Resources:PFSalesResource,ProspectList %>"
                                OnClick="lnkbtnProspectList_Click" Visible="false"><img src="Images/contactList.png"/></asp:LinkButton>
                        </div>
                    </ContentTemplate>
                </asp:UpdatePanel>
                <asp:LinkButton ID="lnkbtnRefresh" Style="float: left;" runat="server" ToolTip="<%$Resources:PFSalesResource,Refresh %>"
                    OnClick="lnkbtnRefresh_Click"><img src="Images/refreshDash.png" height="24px" width="24px" /></asp:LinkButton>
                <%--<asp:ImageButton ID="ImageButton2" ImageUrl="~/Images/addProspects.png" runat="server" />
                <asp:ImageButton ID="ImageButton4" ImageUrl="~/Images/prospectList.png" runat="server" />--%>
            </div>
            <asp:Panel ID="pnlContentPlace" runat="server">
                <asp:UpdatePanel ID="UpPanPrspect" runat="server">
                    <ContentTemplate>
                        ...
                        <asp:Panel ID="pnlAddProsp" runat="server" DefaultButton="lnkbtnSave">
                            <div class="innerHeader">
                                <img src="images/Bullate.jpg" alt="icon Img" />
                                <asp:Label ID="lblAddProspHead" runat="server" Text="<%$Resources:PFSalesResource,TradeInDetails %>"></asp:Label>
                                <div class="addBtn">
                                    <asp:LinkButton ID="lnkbtnBackToSearch" runat="server" Visible="false" ToolTip="<%$Resources:PFSalesResource,BackToSearch %>"
                            ...
                            <asp:Image ID="imgEmpPhoto" runat="server" CssClass="c" Style="width: 122px;" ImageUrl="~/Images/NoPhoto.png" />
                                ...
                                <ajax:ValidatorCalloutExtender ID="vceTotToToday" runat="server" TargetControlID="CompValToTodayDate"
                                    PopupPosition="TopLeft">
                                        ...
                                        <dd>
                                            <asp:TextBox ID="txtSeries" runat="server" TabIndex="35" CssClass="inputClass" MaxLength="20"></asp:TextBox>
                                    ...
                                    <asp:ListItem Value="Other">Other</asp:ListItem>
                                        ...
                                        <dd>
                                            <asp:TextBox ID="txtOdometer" runat="server" TabIndex="35" CssClass="inputClass"
                                    ...
                                    <asp:ListItem Value="Poor">Poor</asp:ListItem>
                                        ...
                                        <dd>
                                            <asp:TextBox ID="txtBodyStyle" runat="server" TabIndex="35" CssClass="inputClass"
                                                MaxLength="20"></asp:TextBox>
                                ...
                                FilterMode="ValidChars" FilterType="Custom" ValidChars="0123456789.">
                                        ...
                                        <dd>
                                            <asp:TextBox ID="txtIntTrimColor" runat="server" TabIndex="37" CssClass="inputClass"
                                                MaxLength="20"></asp:TextBox>
                            ...
                            <dd style="height: auto">
                                ...
                                <ajax:ValidatorCalloutExtender ID="ValidatorCalloutExtender3" runat="server" TargetControlID="CompValToTodayDate"
                                    PopupPosition="TopLeft">
                                        ...
                                        <dd>
                                            <asp:TextBox ID="txtEngineType" runat="server" TabIndex="35" CssClass="inputClass"
                                                MaxLength="20"></asp:TextBox>
                                    ...
                                    <asp:ListItem Value="10 years">10</asp:ListItem>
                                        ...
                                        <dd>
                                            <asp:TextBox ID="txtTransmission" runat="server" TabIndex="34" CssClass="inputClass"
                                                MaxLength="20"></asp:TextBox>
                                ...
                                FilterMode="ValidChars" FilterType="Custom" ValidChars="0123456789.">
                                        ...
                                        <dd>
                                            <asp:TextBox ID="txtExtColor" runat="server" TabIndex="35" CssClass="inputClass"
                                                MaxLength="20"></asp:TextBox>
                                    ...
                                    MaxLength="500" TextMode="MultiLine" Rows="3" Style="height: auto; margin-bottom: 10px;"></asp:TextBox>--%>
                                        ...
                                        <dd>
                                            <asp:TextBox ID="txtRegoExpires" runat="server" TabIndex="39" CssClass="inputClass"
                            ...
                            <div align="center">
                                ...
                                <asp:Label ID="lblCentralLock" runat="server" Text="<%$Resources:PFSalesResource,CentralLocking %>"></asp:Label>--%>
                                    ...
                                    <dl class="checkboxwrap">
                                        ...
                                        <dd>
                                            <asp:CheckBox ID="chkBullBar" runat="server" />
                            ...
                            <dd>
                                <asp:DropDownList runat="server" ID="ddlAirBags" CssClass="selectClass" Width="180px">
                                    ...
                                    <dl class="contactDetailsPop">
                                        ...
                                        <dd>
                                            <asp:DropDownList runat="server" ID="ddlFuelType" CssClass="selectClass" Width="180px">
                                                <asp:ListItem Value="None">None</asp:ListItem>
                                    ...
                                    <dl class="contactDetailsPop">
                                        ...
                                        <dd>
                                            <asp:DropDownList runat="server" ID="DropDownList2" CssClass="selectClass" Width="180px">
                                                <asp:ListItem Value="None">None</asp:ListItem>
                                    ...
                                    <dl class="contactDetailsPop">
                                        ...
                                        <dd>
                                            <asp:DropDownList runat="server" ID="ddlWheelsAlloys" CssClass="selectClass" Width="180px">
                                                <asp:ListItem Value="None">None</asp:ListItem>
                                    ...
                                    <dl class="twocol2">
                                        ...
                                        <dd>
                                            <asp:TextBox ID="txtOtherOptions" runat="server" TabIndex="39" Style="width: 60%;
                                ...
                                <asp:Panel ID="pnlConditions" runat="server" Style="float: left; width: 100%; height: auto;">
                                    ...
                                    <div class="divfull">
                                        ...
                                        <asp:DropDownList ID="ddlRating" TabIndex="5" AutoPostBack="true" CssClass="selectClass"
                                            Style="float: right; margin-top: -17px; margin-right: 104px;" runat="server">
                                            <%--<asp:ListItem Value="0" Text="<%$Resources:PFSalesResource,ddlSelect %>"></asp:ListItem>--%>
                                            <%--<asp:ListItem Value="0">Select years</asp:ListItem>--%>
                                    ...
                                    <dl class="contactDetailsPop">
                                        ...
                                        <dd>
                                            <asp:DropDownList ID="ddlGlasswork" TabIndex="5" AutoPostBack="true" CssClass="selectClass"
                                                runat="server">
                                                <asp:ListItem Value="0" Text="<%$Resources:PFSalesResource,ddlSelect %>"></asp:ListItem>
                                        ...
                                        <dd>
                                            <asp:DropDownList ID="ddlBodyPanels" TabIndex="5" AutoPostBack="true" CssClass="selectClass"
                                                runat="server">
                                                <asp:ListItem Value="0" Text="<%$Resources:PFSalesResource,ddlSelect %>"></asp:ListItem>
                                                <asp:ListItem Value="As New" Text="As New"></asp:ListItem>
                                                <asp:ListItem Value="Good" Text="Good"></asp:ListItem>
                                        ...
                                        <dd>
                                            <asp:DropDownList ID="ddlPaint" TabIndex="5" AutoPostBack="true" CssClass="selectClass"
                                                runat="server">
                                                <asp:ListItem Value="0" Text="<%$Resources:PFSalesResource,ddlSelect %>"></asp:ListItem>
                                                <asp:ListItem Value="As New" Text="As New"></asp:ListItem>
                                                <asp:ListItem Value="Good" Text="Good"></asp:ListItem>
                                        ...
                                        <dd>
                                            <asp:DropDownList ID="ddlTyres" TabIndex="5" AutoPostBack="true" CssClass="selectClass"
                                                runat="server">
                                                <asp:ListItem Value="0" Text="<%$Resources:PFSalesResource,ddlSelect %>"></asp:ListItem>
                                                <asp:ListItem Value="As New" Text="As New"></asp:ListItem>
                                                <asp:ListItem Value="Good" Text="Good"></asp:ListItem>
                                        ...
                                        <dd>
                                            <asp:DropDownList ID="ddlRimsAlloys" TabIndex="5" AutoPostBack="true" CssClass="selectClass"
                                                runat="server">
                                                <asp:ListItem Value="0" Text="<%$Resources:PFSalesResource,ddlSelect %>"></asp:ListItem>
                                                <asp:ListItem Value="As New" Text="As New"></asp:ListItem>
                                                <asp:ListItem Value="Good" Text="Good"></asp:ListItem>
                                        ...
                                        <dd>
                                            <asp:DropDownList ID="ddlUpholstery" TabIndex="5" AutoPostBack="true" CssClass="selectClass"
                                                runat="server">
                                                <asp:ListItem Value="0" Text="<%$Resources:PFSalesResource,ddlSelect %>"></asp:ListItem>
                                                <asp:ListItem Value="As New" Text="As New"></asp:ListItem>
                                                <asp:ListItem Value="Good" Text="Good"></asp:ListItem>
                                    ...
                                    <dl class="contactDetailsPop">
                                        ...
                                        <dd>
                                            <asp:DropDownList ID="ddlEngine" TabIndex="5" AutoPostBack="true" CssClass="selectClass"
                                                runat="server">
                                                <asp:ListItem Value="0" Text="<%$Resources:PFSalesResource,ddlSelect %>"></asp:ListItem>
                                                <asp:ListItem Value="As New" Text="As New"></asp:ListItem>
                                                <asp:ListItem Value="Good" Text="Good"></asp:ListItem>
                                        ...
                                        <dd>
                                            <asp:DropDownList ID="ddlTransmission" TabIndex="5" AutoPostBack="true" CssClass="selectClass"
                                                runat="server">
                                                <asp:ListItem Value="0" Text="<%$Resources:PFSalesResource,ddlSelect %>"></asp:ListItem>
                                                <asp:ListItem Value="As New" Text="As New"></asp:ListItem>
                                                <asp:ListItem Value="Good" Text="Good"></asp:ListItem>
                                        ...
                                        <dd>
                                            <asp:DropDownList ID="ddlBrakes" TabIndex="5" AutoPostBack="true" CssClass="selectClass"
                                                runat="server">
                                                <asp:ListItem Value="0" Text="<%$Resources:PFSalesResource,ddlSelect %>"></asp:ListItem>
                                                <asp:ListItem Value="As New" Text="As New"></asp:ListItem>
                                                <asp:ListItem Value="Good" Text="Good"></asp:ListItem>
                                        ...
                                        <dd>
                                            <asp:DropDownList ID="ddlAC" TabIndex="5" AutoPostBack="true" CssClass="selectClass"
                                                runat="server">
                                                <asp:ListItem Value="0" Text="<%$Resources:PFSalesResource,ddlSelect %>"></asp:ListItem>
                                                <asp:ListItem Value="As New" Text="As New"></asp:ListItem>
                                                <asp:ListItem Value="Good" Text="Good"></asp:ListItem>
                                        ...
                                        <dd>
                                            <asp:DropDownList ID="ddlHeadlights" TabIndex="5" AutoPostBack="true" CssClass="selectClass"
                                                runat="server">
                                                <asp:ListItem Value="0" Text="<%$Resources:PFSalesResource,ddlSelect %>"></asp:ListItem>
                                                <asp:ListItem Value="As New" Text="As New"></asp:ListItem>
                                                <asp:ListItem Value="Good" Text="Good"></asp:ListItem>
                                        ...
                                        <dd>
                                            <asp:DropDownList ID="ddlSpareTyre" TabIndex="5" AutoPostBack="true" CssClass="selectClass"
                                                runat="server">
                                                <asp:ListItem Value="0" Text="<%$Resources:PFSalesResource,ddlSelect %>"></asp:ListItem>
                                                <asp:ListItem Value="As New" Text="As New"></asp:ListItem>
                                                <asp:ListItem Value="Good" Text="Good"></asp:ListItem>
                                ...
                                <asp:Panel ID="pnlOtherInfo" runat="server" Style="float: left; width: 100%; height: auto;">
                                    ...
                                    <dl class="twocol">
                                        ...
                                        <dd>
                                            <asp:TextBox ID="txtDescDent" runat="server" TabIndex="39" Style="width: 100%; height: 40px;"
                                        ...
                                        <dd>
                                            <asp:TextBox ID="txtAccident" runat="server" TabIndex="39" Style="width: 100%; height: 40px;"
                                                CssClass="inputClass" MaxLength="500" TextMode="MultiLine"></asp:TextBox></dd>
                                        </dd>
                                        <dt>
                                            <asp:Label ID="lblOwners" runat="server" Text="How many people(including yourself) have owned this vehicle?"></asp:Label></dt>
                                        <dd>
                                            <asp:DropDownList runat="server" ID="ddlOwners" CssClass="selectClass" Width="180px">
                                                <asp:ListItem Value="1">1</asp:ListItem>
                                                <asp:ListItem Value="2">2</asp:ListItem>
                                            </asp:DropDownList>
                                        </dd>
                                        ...
                                        <dd>
                                            <asp:TextBox ID="txtRepalce" runat="server" TabIndex="39" Style="width: 100%; height: 40px;"
                                                CssClass="inputClass" MaxLength="500" TextMode="MultiLine"></asp:TextBox></dd>
                                        </dd>
                                        <dt>
                                            <asp:Label ID="lblLogBook" runat="server" Text="How complete is the service history(Log books)?"></asp:Label></dt>
                                        <dd>
                                            <asp:DropDownList runat="server" ID="ddlLogBook" CssClass="selectClass" Width="180px">
                                        ...
                                        <dd>
                                            <asp:TextBox ID="txtPayout" runat="server" TabIndex="39" Style="width: 100%; height: 40px;"
                                                CssClass="inputClass" MaxLength="500" TextMode="MultiLine"></asp:TextBox></dd>
                                        </dd>
                                        <dt>
                                        ...
                                        <dd>
                                            <asp:TextBox ID="txtAnything" runat="server" TabIndex="39" Style="width: 100%; height: 40px;"
                                                CssClass="inputClass" MaxLength="500" TextMode="MultiLine"></asp:TextBox></dd>
                                        </dd>
