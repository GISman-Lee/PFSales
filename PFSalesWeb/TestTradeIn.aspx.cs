...
public partial class TestTradeIn : System.Web.UI.Page
{
    #region Private Varriables
    ILog Logger = LogManager.GetLogger(typeof(TestTradeIn));
    ...
    protected void lnkbtnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ViewState["ProspId"] != null && BasePage.UserSession != null)
            {
                ...
                //objProsp.FConsultant = txtFConsultant.Text.Trim();ayyaj
                //objProsp.FConsultId = Convert.ToInt64(ddlFConsultant.SelectedValue.Trim());ayyaj
                ...
                //objProsp.SourceId = Convert.ToInt64(ddlSource.SelectedValue.Trim());ayyaj
                objProsp.CityId = Convert.ToInt64(ddlCity.SelectedValue.Trim());
                //objProsp.PostalCode = ddlPostalCode.SelectedValue.Trim();ayyaj
                //objProsp.Finance = Convert.ToInt16(ddlFinance.SelectedValue.Trim());ayyaj
                //objProsp.LeadSource = txtReferredBy.Text.Trim();ayyaj
                objProsp.CreatedById = BasePage.UserSession.VirtualRoleId;
    ...
    {
        //ddlFConsultant.SelectedValue = ddlFinance.SelectedValue = ddlTitle.SelectedValue = ddlConsultant.SelectedValue = ddlSource.SelectedValue = ddlCarMake.SelectedValue = "0";//ddlWhereDidUHear.SelectedValue = ayyaj
        ...
        ////txtComments.Text = txtReferredBy.Text = txtFName.Text = txtMName.Text = txtLName.Text  = txtMemNo.Text = txtAddName.Text = txtPhNo.Text = txtMobile.Text = txtAddLine1.Text = txtAddLine2.Text = txtAddLine3.Text = txtFax.Text = txtEmail1.Text = txtAlterEmail.Text = txtAltContNo.Text = string.Empty;//txtPostalCode.Text =ayyaj
        //hdfPhPopType.Value = "";
        ////chkTradeIn.Checked = false;ayyaj
        //BindFormats();
        //SetDefaultFormat();
